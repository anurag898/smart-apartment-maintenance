...
public class CreditActivity extends AppCompatActivity implements DatePickerDialog.OnDateSetListener {
    ...
    Button creditsubmit;
    AppCompatEditText fno,mamount,mdesc;
    TextView mdate;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        creditsubmit.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
//            String amount = mamount.getText().toString();
//            String date = mdate.getText().toString();
//            String desc = mdesc.getText().toString();
                if(!CheckNetwork.isInternetAvailable(CreditActivity.this))
                {
                    AlertDialog.Builder builder
                            = new AlertDialog
                            .Builder(CreditActivity.this);
                ...
                if(fno.getText().toString().isEmpty()){
                    fno.setError("Please enter Flat no");
                    fno.requestFocus();
                }
    ...
    private void init() {
        ...
        creditsubmit = findViewById(R.id.debit_submit);
    }
